...
Вітаю у публічній репозиторії українського перекладу **Kaishi 1.5k** - сучасної колоди Anki створеної, щоб дозволити початківцям отримати базовий японський словниковий запас і розпочати ваше вивчення японської.
...
Щоб використовувати потрібно мати чи встановити [Anki](https://apps.ankiweb.net/), після цього можна змінити інтерфейс на українську (ctrl+p і там Language), або цього не робити. Далі встановити .apkg файл зі сторінки [релізів](https://github.com/maksiksking/KaishiUa/releases) чи з [AnkiWeb (нема поки)](#), і імпортувати колоду кнопкою `Імпортувати файл` -> `Імпорт`. Далі використовувати, як саме описано далі.
...
Альтернативна канонічна назва цього перекладу крім KaishiUa це:
